...
import { Plus, Search, Filter, PiggyBank, MoreHorizontal, Building2, ChevronDown } from "lucide-react";
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex justify-end items-center gap-2 mb-2">
        <button className="flex items-center gap-2 px-4 py-2.5 text-xs font-bold text-white bg-[#2ac1bc] hover:bg-[#72b3a3] rounded-xl shadow-md shadow-[#2ac1bc]/20 transition-all cursor-pointer">
          <Plus className="w-4 h-4" /> Thêm khoản đặt cọc mới
        </button>
      </div>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          <div className="space-y-2 max-w-xl">
            ...
            <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed">
              Quản lý cọc giữ chỗ, cọc hợp đồng, chuyển đổi cọc từ BHRP và khấu trừ khi thanh lý.
            </p>
          </div>
          ...
          <div className="flex flex-col items-end gap-3 w-full lg:w-auto">
            <div className="grid grid-cols-2 lg:flex lg:flex-row lg:justify-end gap-3 w-full">
              ...
              <div className="flex items-center gap-3 px-4 py-2.5 bg-rose-500/10 hover:bg-rose-500/20 transition-colors rounded-2xl border border-rose-500/30 backdrop-blur-md min-w-[145px]">
                <PiggyBank className="w-4 h-4 text-rose-500 shrink-0" />
                <div className="flex flex-col">
                  <span className="text-[9px] uppercase font-bold text-rose-400 tracking-wider">Tổng cọc giữ</span>
                  <span className="font-black text-rose-500 text-lg leading-none mt-1">3.00M ₫</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 lg:flex lg:flex-row lg:justify-end gap-3 w-full">
              <div className="flex items-center gap-3 px-4 py-2.5 bg-[#2ac1bc]/10 hover:bg-[#2ac1bc]/20 transition-colors rounded-2xl border border-[#2ac1bc]/30 backdrop-blur-md min-w-[135px]">
                ...
                <div className="flex flex-col">
                  <span className="text-[9px] uppercase font-bold text-[#2ac1bc] tracking-wider">Đang giữ</span>
                  <span className="font-black text-[#2ac1bc] text-lg leading-none mt-1">3.00M ₫</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 px-4 py-2.5 bg-[#FF6B35]/10 hover:bg-[#FF6B35]/20 transition-colors rounded-2xl border border-[#FF6B35]/30 backdrop-blur-md min-w-[135px]">
                ...
                <div className="flex flex-col">
                  <span className="text-[9px] uppercase font-bold text-[#FF6B35] tracking-wider">Đã khấu trừ</span>
              ...
              <div className="flex items-center gap-3 px-4 py-2.5 bg-purple-500/10 hover:bg-purple-500/20 transition-colors rounded-2xl border border-purple-500/30 backdrop-blur-md min-w-[135px]">
                ...
                <div className="flex flex-col">
                  <span className="text-[9px] uppercase font-bold text-purple-400 tracking-wider">Đã hoàn cọc</span>
                  <span className="font-black text-purple-400 text-lg leading-none mt-1">0 ₫</span>
                </div>
              </div>
            </div>
          </div>
