...
const formatLargeMoney = (amount: number, unitBillion: string = "B ₫", unitMillion: string = "M ₫"): string => {
      ...
      <div className="bg-white p-3.5 sm:p-4 border border-zinc-200/80 rounded-2xl shadow-2xs space-y-3.5">
        ...
        <div className="overflow-x-auto no-scrollbar py-0.5 -mx-1 px-1 flex items-center justify-between gap-2 shrink-0 text-xs font-bold">
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            >
              {t("landlordDepositsStatusHolding")} ({selectedDepositTypeTab === "Cọc giữ chỗ" ? stats.holdTypeHoldingCountTotal : stats.holdingCountTotal - stats.holdTypeHoldingCountTotal})
            </button>
