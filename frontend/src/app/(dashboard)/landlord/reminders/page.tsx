...
import {
 ...
 UserCheck, Sparkles, Search, ChevronDown,
...
export default function RemindersPage() {
 ...
 // Fetch real broadcast announcements from backend API
 ...
 const closeAndResetTaskModal = () => setIsTaskModalOpen(false);
 const closeAndResetNotifModal = () => setIsNotifModalOpen(false);
 const requestCloseTaskModal = closeAndResetTaskModal;
 const requestCloseNotifModal = closeAndResetNotifModal;
 ...
 // Broadcast announcement via real API
 ...
 {/* 5. Tab 2: Tenant Notifications Broadcast Section ( Real Backend Data) */}
 {activeTab === "notifications" && (
 <div className="space-y-4">
 {isLoadingNotifs ? (
 ...
 <span className={`px-2.5 py-0.5 text-[10px] font-black rounded-md uppercase shrink-0 ${notif.category === "Khẩn cấp" || notif.category === "Emergency" ? "bg-rose-500/15 text-rose-600 border border-rose-500/30" :
 ...
 <span className={`px-2 py-0.5 text-[10px] font-black rounded-md uppercase shrink-0 ${notif.category === "Khẩn cấp" || notif.category === "Emergency" ? "bg-rose-500/15 text-rose-600 border border-rose-500/30" :
 notif.category === "Điện nước" || notif.category === "Utilities" ? "bg-amber-500/15 text-amber-600 border border-amber-500/30" :
 notif.category === "Tiền nhà" || notif.category === "Rent" ? "bg-emerald-500/15 text-emerald-700 border border-emerald-500/30" :
 "bg-blue-500/15 text-blue-600 border border-blue-500/30"
 }`}>
 ...
 {/* 7. MODAL 2: Create Tenant Broadcast Modal */}
 {isNotifModalOpen && (
 <div
 className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200"
