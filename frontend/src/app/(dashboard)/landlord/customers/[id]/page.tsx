  ...
  if (!customer) {
    return (
      <div className="p-8 text-center bg-white rounded-2xl border border-zinc-200 text-zinc-500 my-6">
        <p className="font-bold text-lg mb-2 text-zinc-800">{t("tenantNotFound")}</p>
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-white p-4 sm:p-5 rounded-2xl border border-zinc-200/80 shadow-xs">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className={`px-2.5 py-0.5 text-[10px] font-extrabold rounded-full uppercase tracking-wider border shrink-0 ${customer.status === 'Đang ở'
                  ...
                  {customer.status === 'Đang ở' ? t('staying') : customer.status === 'Sắp hết hợp đồng' ? t('expiringSoon') : t('left')}
                </span>
              </div>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto pt-2 md:pt-0 border-t md:border-t-0 border-zinc-100">
          ...
          >
            <Edit2 className="w-3.5 h-3.5 text-[#2AC1BC]" /> {t("editInfo")}
          </button>
          <button
            onClick={() => {
              setConfirmModal({
                ...
                message: `${t("confirmDeleteMsg")} (${customer.name} - ${customer.cccd})`,
                onConfirm: () => {
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-zinc-200/80 rounded-2xl p-5 sm:p-6 shadow-xs space-y-5">
            <h3 className="font-black text-zinc-900 text-sm uppercase tracking-wider flex items-center gap-2 border-b border-zinc-100 pb-3">
              <User className="w-4 h-4 text-[#2AC1BC]" /> {t("personalInfo")}
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("fullNameLabel")}</span>
                <p className="font-extrabold text-zinc-900 text-sm">{customer.name}</p>
              </div>

              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("cccdLabel")}</span>
                <p className="font-black text-[#2AC1BC] text-sm tracking-wide">{customer.cccd}</p>
              </div>

              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("dobLabel")}</span>
                <p className="font-bold text-zinc-800">{customer.dob || "01/01/2000"}</p>
              </div>

              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("genderLabel")}</span>
                <p className="font-bold text-zinc-800">{customer.gender === "nam" ? t("genderMale") : t("genderFemale")}</p>
              </div>

              <div className="sm:col-span-2 p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("addressLabel")}</span>
          ...
          <div className="bg-white border border-zinc-200/80 rounded-2xl p-5 sm:p-6 shadow-xs space-y-5">
            <h3 className="font-black text-zinc-900 text-sm uppercase tracking-wider flex items-center gap-2 border-b border-zinc-100 pb-3">
              <Phone className="w-4 h-4 text-[#2AC1BC]" /> {t("contactAndWork")}
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("phoneNumberUpper")}</span>
              ...
              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("jobLabel")}</span>
                <p className="font-bold text-zinc-800">{customer.job || "Sinh viên / Kỹ sư"}</p>
              </div>

              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1">
                <span className="text-[10px] font-bold text-zinc-400 uppercase">{t("workplaceUpper")}</span>
          ...
          <div className="bg-white border border-zinc-200/80 rounded-2xl p-5 sm:p-6 shadow-xs space-y-4">
            <div className="flex justify-between items-center border-b border-zinc-100 pb-3">
              <h3 className="font-black text-zinc-900 text-sm uppercase tracking-wider flex items-center gap-2">
                <CreditCard className="w-4 h-4 text-[#2AC1BC]" /> {t("idCardsSection")}
              </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <span className="text-xs font-bold text-zinc-600 block">{t("frontIdCard")}</span>
                <div
              ...
              <div className="space-y-1.5">
                <span className="text-xs font-bold text-zinc-600 block">{t("backIdCard")}</span>
                <div
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-zinc-200/80 rounded-2xl p-5 shadow-xs space-y-4">
            <h3 className="font-black text-zinc-900 text-xs uppercase tracking-wider flex items-center gap-2 border-b border-zinc-100 pb-3">
              <Home className="w-4 h-4 text-[#2AC1BC]" /> {t("contractAndCurrentRoom")}
            </h3>
              ...
              <div className="space-y-3">
                <div className="p-3.5 bg-[#2AC1BC]/10 rounded-2xl border border-[#2AC1BC]/30 space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold text-zinc-600">{t("currentlyRenting")}</span>
                    <Link
                    ...
                    >
                      {t("roomWord")} {customer.room} <ExternalLink className="w-3.5 h-3.5" />
                    </Link>
                  </div>
                  <div className="text-[10px] text-zinc-500 font-semibold border-t border-[#2AC1BC]/20 pt-2 flex justify-between">
                    <span>{t("buildingPrefix")} {customer.building === "vinahouse" ? "Dormio Campus" : "Dormio Premier"}</span>
                    <span>{t("floorPrefix")} {customer.room.charAt(0)}</span>
                  </div>
                </div>
                ...
                <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 space-y-1 text-xs">
                  ...
                  <div className="flex justify-between text-[11px] text-emerald-700 font-bold pt-1">
                    <span>{t("holdingDepositLabel")}</span>
                ...
                >
                  <Home className="w-4 h-4" /> {t("viewRoomDetailBtn")} {customer.room} &rarr;
                </Link>
              </div>
            ) : (
          ...
          <div className="bg-white border border-zinc-200/80 rounded-2xl p-5 shadow-xs space-y-4">
            <h3 className="font-black text-zinc-900 text-xs uppercase tracking-wider flex items-center gap-2 border-b border-zinc-100 pb-3">
              <Clock className="w-4 h-4 text-[#2AC1BC]" /> {t("stayHistoryTitle")}
            </h3>
            ...
            <div className="space-y-2.5">
              <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100 text-xs space-y-1">
                ...
                <p className="text-[10px] text-zinc-500">{t("fromDate")} 01/01/2026 - {t("toDate")}</p>
              </div>
              ...
              <div className="p-3 bg-zinc-50/60 rounded-xl border border-zinc-100 text-xs space-y-1">
                ...
                <p className="text-[10px] text-zinc-400">{t("fromDate")} 01/01/2024 - 31/12/2025</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl shadow-xl overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-5 border-b border-zinc-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black text-zinc-900">{t("editTenantTitlePrefix")} {customer.name}</h2>
                  <p className="text-xs text-zinc-500 font-medium">{t("editTenantSubtitle")}</p>
                </div>
              </div>
            ...
            <div className="p-6 overflow-y-auto max-h-[75vh] space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("fullNameLabel")}</label>
                  <input
                    type="text"
                    value={editName}
                ...
                <div>
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("phoneLabel")}</label>
                  <input
                    type="text"
                    value={editPhone}
                ...
                <div>
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("cccdLabel")}</label>
                  <input
                    type="text"
                    value={editCccd}
                ...
                <div>
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("dobLabel")}</label>
                  <input
                    type="date"
                    value={editDob}
                ...
                <div>
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("genderLabel")}</label>
                  <select
                    value={editGender}
                ...
                <div className="md:col-span-2">
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("addressLabel")}</label>
                  <input
                    type="text"
                    value={editAddress}
                ...
                <div>
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("jobLabel")}</label>
                  <input
                    type="text"
                    value={editJob}
                ...
                <div>
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("workplaceLabel")}</label>
                  <input
                    type="text"
                    value={editWorkplace}
                ...
                <div className="md:col-span-2">
                  <label className="block text-xs font-bold text-zinc-700 mb-1">{t("notesLabel")}</label>
                  <textarea
                    rows={3}
                    value={editNote}
