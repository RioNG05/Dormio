                                        ...
                                        <div className="mt-2 flex flex-wrap gap-1.5">
                                            {nameFormatPresets.map((preset) => (
                                                <button
                                                    ...
                                                    className={`text-[11px] px-2.5 py-1 rounded-lg border font-medium transition-colors ${roomsConfig.nameFormat === preset.value
                                        ...
                                        {services
                                            ...
                                            .map((service, idx) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <span
                                                            className={`w-3 h-3 rounded-full flex items-center justify-center border text-[9px] ${isSelected
...
function StepperItem({
    ...
    return (
        <button
            type="button"
            onClick={onClick}
            className={`flex items-center gap-3 p-3 rounded-2xl border text-left transition-all ${isActive
        ...
        >
            <div
                className={`w-9 h-9 rounded-xl flex items-center justify-center text-xs font-bold shrink-0 transition-colors ${isCompleted
            ...
            <div className="min-w-0 hidden sm:block">
                ...
                <p
                    className={`text-xs font-black truncate ${isActive ? "text-zinc-900" : "text-zinc-600"
                        }`}
                >
                    {title}
                </p>
