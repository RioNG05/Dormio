      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-16 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-2">
              <span className="text-xs font-extrabold text-[#2AC1BC] uppercase tracking-wider block">{t("directChannels")}</span>
            ...
            <div className="space-y-4 pt-2">
              ...
              >
                ...
                <div>
                  <h3 className="font-extrabold text-zinc-900 text-sm">{t("hotlineTitle")}</h3>
                  <p className="text-xs font-black text-[#FF6B35] mt-0.5 group-hover:underline">0901.234.567 (24/7)</p>
                  <span className="text-[10px] text-zinc-400 font-medium block mt-1">{t("hotlineSub")}</span>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <h3 className="font-extrabold text-zinc-900 text-sm">{t("emailTitle")}</h3>
                  <p className="text-xs font-semibold text-zinc-800 mt-0.5 group-hover:text-[#2AC1BC] group-hover:underline">support@dormio.vn</p>
                  <span className="text-[10px] text-zinc-400 font-medium block mt-1">{t("emailSub")}</span>
                </div>
              </a>
              ...
              <div className="p-5 rounded-3xl bg-zinc-50 border border-zinc-200/80 flex items-start gap-4 hover:border-zinc-400 transition-all group shadow-xs">
                ...
                <div className="space-y-1">
                  <h3 className="font-extrabold text-zinc-900 text-sm">{t("officeTitle")}</h3>
                  <p className="text-xs text-zinc-600 font-medium leading-relaxed">{t("officeAddress")}</p>
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-zinc-200/80 shadow-xl space-y-6">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h3 className="text-xl font-black text-zinc-900">{t("successTitle")}</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="border-b border-zinc-100 pb-3">
                  <h3 className="text-lg font-black text-zinc-900">{t("formTitle")}</h3>
                  <p className="text-xs text-zinc-500 font-medium">{t("formSubtitle")}</p>
                </div>

                {/* Topic Selection */}
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("topicLabel")}</label>
                  <div className="relative">
                    ...
                    >
                      <option value="tu-van">{t("topicOpt1")}</option>
                      <option value="bhrp">{t("topicOpt2")}</option>
                      <option value="ky-thuat">{t("topicOpt3")}</option>
                      <option value="khac">{t("topicOpt4")}</option>
                    </select>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("contentLabel")}</label>
                  <textarea
                    rows={4}
        ...
        <div className="bg-zinc-900 rounded-3xl p-8 sm:p-12 text-white text-center space-y-6 shadow-2xl border border-zinc-800">
          <h2 className="text-2xl sm:text-4xl font-black text-white leading-snug">
            <span className="inline-block whitespace-nowrap">{t("alwaysReady")}</span>
          </h2>
