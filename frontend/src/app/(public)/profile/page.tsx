    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center p-6 space-y-6">
        ...
        <div className="space-y-2 max-w-md">
          <h2 className="text-2xl font-black text-zinc-900">{t("loginRequiredTitle")}</h2>
              ...
              <div className="space-y-2">
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                  <span className="px-3 py-1 bg-[#2AC1BC]/20 text-[#2AC1BC] text-[10px] font-black rounded-full border border-[#2AC1BC]/30 uppercase tracking-wider flex items-center gap-1 whitespace-nowrap">
                    <ShieldCheck className="w-3.5 h-3.5" /> {t("ekycVerified")}
                  </span>
                ...
                <p className="text-xs text-zinc-400 font-medium">{t("subTitle")}</p>
        ...
        <div className="w-full border-b border-zinc-200 pb-3">
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap lg:flex-nowrap items-stretch sm:items-center gap-2 w-full">
            ...
            >
              ...
              <span>{isLandlord ? t("tab2Landlord") : t("tab2Tenant")}</span>
            </button>
          ...
          <form onSubmit={handleSaveInfo} className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-8 border border-zinc-200/80 shadow-sm space-y-6">
              ...
              <div className="border-b border-zinc-100 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <h3 className="text-base font-black text-zinc-900">{t("identityHeader")}</h3>
                  <p className="text-xs text-zinc-500 font-medium">{t("identitySub")}</p>
                </div>
                ...
                {!isEditingInfo ? (
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                    ...
                    >
                      <Save className="w-4 h-4 shrink-0" /> {t("saveBtn")}
                    </button>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("fullNameLabel")}</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("phoneLabel")}</label>
                  <input
                    type="text"
                    disabled={!isEditingInfo}
                    value={phone}
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-zinc-700">{t("addressLabel")}</label>
                <input
                  type="text"
                  disabled={!isEditingInfo}
                  value={address}
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-8 border border-zinc-200/80 shadow-sm space-y-5">
              <div className="border-b border-zinc-100 pb-3 flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <h3 className="text-base font-black text-zinc-900">{t("ekycHeader")}</h3>
                </div>
              ...
              {isEditingInfo && (
                <div className="p-3.5 bg-amber-500/10 border border-amber-500/30 text-amber-700 rounded-2xl text-xs font-semibold flex items-center gap-2">
                  ...
                  <span>{t("cccdWarning")}</span>
                </div>
              )}

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase block">{t("cccdNumberLabel")}</label>
                  <input
                    type="text"
                    disabled={!isEditingInfo}
                    value={identityCard}
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase block">{t("issueDateLabel")}</label>
                  <input
                    type="text"
                    disabled={!isEditingInfo}
                    value={idIssueDate}
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase block">{t("issuePlaceLabel")}</label>
                  <input
                    type="text"
                    disabled={!isEditingInfo}
                    value={idIssuePlace}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-2 text-center">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-extrabold text-zinc-700">{t("cccdFront")}</span>
                    {isEditingInfo && (
                  ...
                  <div className="aspect-[16/10] bg-zinc-200 rounded-xl overflow-hidden relative group border border-zinc-300">
                    ...
                    />
                    <span className="absolute bottom-2 right-2 px-2 py-0.5 bg-emerald-500 text-white text-[9px] font-black rounded-md whitespace-nowrap">{t("faceMatched")}</span>
                  </div>
                </div>

                <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-2 text-center">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-extrabold text-zinc-700">{t("cccdBack")}</span>
                    {isEditingInfo && (
                      <span className="text-[10px] font-bold text-[#2AC1BC] cursor-pointer hover:underline flex items-center gap-1 whitespace-nowrap">
                        <Upload className="w-3 h-3 shrink-0" /> Tải ảnh mới
                      </span>
                  ...
                  <div className="aspect-[16/10] bg-zinc-200 rounded-xl overflow-hidden relative group border border-zinc-300">
                    <img
                      ...
                      className="w-full h-full object-cover"
                    />
                    <span className="absolute bottom-2 right-2 px-2 py-0.5 bg-emerald-500 text-white text-[9px] font-black rounded-md whitespace-nowrap">{t("fingerprintValid")}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-8 border border-zinc-200/80 shadow-sm space-y-5">
              <div className="border-b border-zinc-100 pb-3">
                <h3 className="text-base font-black text-zinc-900">{t("emergencyHeader")}</h3>
                <p className="text-xs text-zinc-500 font-medium">{t("emergencySub")}</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("emergencyNameLabel")}</label>
                  <input
                    type="text"
                    disabled={!isEditingInfo}
                    value={emergencyName}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("emergencyPhoneLabel")}</label>
                  <input
                    type="text"
                    disabled={!isEditingInfo}
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            {isLandlord ? (
              <div className="bg-white rounded-3xl p-5 sm:p-8 border border-zinc-200/80 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-1">
                    <span className="text-[10px] font-bold text-zinc-400 uppercase block">{t("roomsManagedLabel")}</span>
                    <span className="text-lg font-black text-zinc-900 block">10 {t("roomsUnit")}</span>
                  </div>

                  <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-1">
                    <span className="text-[10px] font-bold text-zinc-400 uppercase block">{t("monthlyRevenueLabel")}</span>
                    <span className="text-lg font-black text-[#2AC1BC] block">45.000.000đ</span>
                  </div>

                  <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-1">
                    <span className="text-[10px] font-bold text-zinc-400 uppercase block">{t("subPlanLabel")}</span>
                    <span className="text-xs font-black text-emerald-600 block uppercase">{t("proTier")}</span>
                  </div>
                </div>
              </div>
            ) : (
              <div className="bg-white rounded-3xl p-5 sm:p-8 border border-zinc-200/80 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-1">
                    <span className="text-[10px] font-bold text-zinc-400 uppercase block">{t("monthlyRentLabel")}</span>
                    <span className="text-xl font-black text-rose-500 block">4.500.000đ{t("perMonthUnit")}</span>
                  </div>

                  <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-1">
                    <span className="text-[10px] font-bold text-zinc-400 uppercase block">{t("depositEscrowLabel")}</span>
                    <span className="text-xl font-black text-[#2AC1BC] block">1.000.000đ</span>
                    <span className="text-[9px] text-emerald-600 font-bold block">✓ {t("escrowProtected")}</span>
                  </div>

                  <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-1">
                    <span className="text-[10px] font-bold text-zinc-400 uppercase block">{t("leaseTermLabel")}</span>
                    <span className="text-sm font-black text-zinc-900 block">01/01/2026 - 31/12/2026</span>
                    <span className="text-[9px] text-zinc-500 font-bold block">{t("stayDurationLabel")}</span>
                  </div>
                </div>
                ...
                <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200/80 space-y-2">
                  <div className="flex flex-col sm:flex-row justify-between text-xs font-bold text-zinc-700 gap-1">
                    <span>{t("tenureProgress")}</span>
                    <span>{t("tenureRemaining")}</span>
                  </div>
                ...
                <div className="p-5 sm:p-6 bg-gradient-to-r from-zinc-900 via-zinc-900 to-zinc-950 text-white rounded-3xl space-y-4 shadow-xl border border-zinc-800">
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                    <div>
                      <h4 className="text-sm font-black text-white">{t("landlordBoxTitle")}</h4>
                      <p className="text-xs text-zinc-400 font-medium">{t("landlordContactText")}</p>
                    </div>
        ...
        {activeTab === "bank" && (
          <form onSubmit={handleSaveBank} className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-8 border border-zinc-200/80 shadow-sm space-y-6">
              ...
              <div className="border-b border-zinc-100 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <h3 className="text-base font-black text-zinc-900">{t("bankHeader")}</h3>
                  <p className="text-xs text-zinc-500 font-medium">{t("bankSub")}</p>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-700">{t("bankNameLabel")}</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-700">{t("bankAccountLabel")}</label>
                    <input
                      type="text"
                      disabled={!isEditingBank}
                      value={bankAccount}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-700">{t("bankHolderLabel")}</label>
                    <input
                      type="text"
                      disabled={!isEditingBank}
                ...
                <div className="p-6 bg-gradient-to-br from-zinc-900 to-zinc-950 text-white rounded-3xl border border-zinc-800 space-y-4 text-center shadow-xl relative overflow-hidden w-full">
                  ...
                  <div className="relative z-10">
                    <h4 className="text-sm font-black text-white">{bankName || t("bankNameLabel")}</h4>
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-8 border border-zinc-200/80 shadow-sm space-y-6 w-full">
              ...
              <div className="border-b border-zinc-100 pb-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <h3 className="text-base font-black text-zinc-900">{t("securityHeader")}</h3>
                  <p className="text-xs text-zinc-500 font-medium">{t("securitySub")}</p>
                </div>
                ...
                <div className="p-5 bg-zinc-900 text-white rounded-2xl space-y-4 animate-in slide-in-from-top-2 duration-200">
                  <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="text-xs font-black text-white">{t("otpRecoveryHeader")}</h4>
                    </div>
                    <button
                  ...
                  {!otpSent ? (
                    <div className="space-y-3">
                      <p className="text-xs text-zinc-300 font-medium">{t("otpSendDesc")} <strong className="text-[#2AC1BC]">{phone}</strong></p>
                      <button
                        type="button"
                    ...
                    <div className="space-y-3">
                      <p className="text-xs text-emerald-400 font-bold">✓ {t("otpSentDesc")} {phone}. Vui lòng nhập mã 6 chữ số:</p>
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <input
                          type="text"
                          maxLength={6}
              ...
              <form onSubmit={handleSavePassword} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("currentPassLabel")}</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("newPassLabel")}</label>
                  <div className="relative">
                    <input
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-zinc-700">{t("confirmNewPassLabel")}</label>
                  <input
                    type="password"
                    required
                    placeholder="••••••••"
