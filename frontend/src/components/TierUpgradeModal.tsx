...
export default function TierUpgradeModal() {
  ...
  const benefits = isPro
    ? [
        "Phân quyền quản lý nhân viên & phân công ca trực (UC-L-19, UC-L-20)",
        "Lập lịch làm việc & tuần hoàn ca làm (UC-L-21)",
        "Chấm công điện tử & giám sát ca làm việc (UC-L-22)",
        "Chuyển đổi ngữ cảnh & báo cáo thống kê đa nhà trọ (UC-L-23, UC-L-24)",
      ]
    : [
        "Quản lý chi phí vận hành & hóa đơn chi tiêu (UC-L-17)",
        "Quản lý & xử lý tiền cọc giữ chỗ (UC-L-14)",
        "Gửi thông báo phát thanh tới toàn bộ cư dân (UC-L-13)",
        "Xuất hợp đồng & tài liệu pháp lý trực tuyến (UC-L-15)",
        "Quản lý tài sản & kiểm kê trang thiết bị (UC-L-25)",
      ];
