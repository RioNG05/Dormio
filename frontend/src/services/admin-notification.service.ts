...
export const adminNotificationService = {
 /**
 * Retrieves paginated list of mass notification jobs with filters and status counters.
 */
 ...
 /**
 * Retrieves single mass notification job detail.
 */
 ...
 /**
 * Creates and enqueues a new mass notification job.
 */
 ...
 /**
 * Retries a failed or stalled mass notification job.
 */
