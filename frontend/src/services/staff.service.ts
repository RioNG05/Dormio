...
export const staffService = {
 /**
 * Search user by phone or name ( Step 1)
 */
 ...
 */
 ...
 /**
 * List staff members with pagination and summary
 */
 async getStaffList(
 buildingId: string,
 ...
 */
 ...
 /**
 * Update staff status or position
 */
 ...
 /**
 * Get single staff assignment detail
 */
 ...
 /**
 * Assign or re-assign role to staff member ( Step 3)
 */
 async assignRole(
 buildingId: string,
 assignmentId: string,
 ...
 /**
 * Update job position title and duties description
 */
