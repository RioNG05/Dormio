...
export const landlordInvoiceService = {
 /**
 * Retrieves paginated invoices for a boarding house with summary metrics
 */
 ...
 /**
 * Retrieves complete invoice detail by ID
 */
 ...
 /**
 * Creates manual billing invoice for a room
 */
 ...
 /**
 * Records manual payment (cash or external transfer) for an invoice ( Part 3)
 */
 ...
 /**
 * Retrieves room debt ledger with summary metrics and aging calculation
 */
 ...
 /**
 * Dispatches debt reminder to primary tenant of room
 */
 ...
 /**
 * Triggers manual update of overdue status for unpaid invoices past due date
 */
