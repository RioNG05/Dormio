...
export const staffAttendanceService = {
 /**
 * Fetch today's schedule, duties, coworkers and attendance status
 */
 ...
 /**
 * Fetch monthly attendance summary metrics for logged-in staff
 */
 ...
 /**
 * Fetch paginated timesheet history, attendance metrics and watermark photo proofs
 */
 ...
 /**
 * Submit staff check-in with GPS photo watermark and optional late explanation
 */
 ...
 /**
 * Submit staff check-out with GPS photo watermark and optional early explanation
 */
 ...
 /**
 * Submit photo proof and progress note for duty task
 */
 ...
 /**
 * Fetch available shift types for staff member
 */
