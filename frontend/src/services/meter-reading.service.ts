...
export interface AiMeterReadingResult {
    isValid: boolean;
...
export interface AiMeterOcrResponse {
    success: boolean;
    data: AiMeterReadingResult;
    message?: string;
}

export const meterReadingService = {
    /**
     * Send meter image directly to AI first for validation and OCR extraction
     */
    async scanMeterWithAi(
        imageUrl: string,
        serviceType: string = "general",
    ): Promise<AiMeterOcrResponse> {
        const response = await api.post<AiMeterOcrResponse>(
            "/v1/ai/vision/meter-reading",
            { imageUrl, serviceType }
        );
        return response;
    },
    /**
    * Get active metered services and draft readings
    */
    ...
    /**
    * Step 2 & 3: Upload meter photo and run OCR / in-place upsert
    */
    ...
    /**
    * Manually correct unbilled reading value
    */
    ...
    /**
    * Confirm all readings and generate invoice
    */
    ...
    // ─── Landlord Utility Logging ───────────────────────────────────

    /**
    * Get active metered services and latest readings for room
    */
    ...
    /**
    * Get chronological meter reading history for a room
    */
    ...
    /**
    * Manually record utility meter readings for room
    */
    ...
    /**
    * Update / correct a recorded meter reading with reason
    */
