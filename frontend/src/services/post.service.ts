...
/** Public address derived from BoardingHouse */
...
/** Public poster subset — phone/email never exposed ( rule) */
...
/**
 * Public Poster Profile Response
 */
...
/** Public listing item for browse endpoint */
...
export const postService = {
 /**
 * Browse & filter public rental listings (no auth required)
 ...
 */
 ...
 /**
 * Get public poster profile by ID (no auth required, privacy-guarded contact)
 */
 ...
 */
 ...
 /**
 * Place a platform deposit on a rental listing (no auth required).
 ...
 */
 ...
 /**
 * Get aggregate poster analytics overview
 */
 ...
 /**
 * Get single post drill-down analytics
 */
 ...
 /**
 * Save/bookmark a rental listing (requires auth)
 */
 ...
 /**
 * Unsave/remove bookmark for a rental listing (requires auth)
 */
 ...
 /**
 * Toggle save/bookmark status for a rental listing (requires auth)
 */
 ...
 /**
 * Get all saved post IDs for current user (requires auth)
 */
 ...
 /**
 * Get all saved rental listings for current user (requires auth)
 */
 ...
 /**
 * Check if a post is bookmarked by current user (requires auth)
 */
 ...
 /**
 * Initiate platform deposit with VietQR instruction
 */
 ...
 /**
 * Confirm platform deposit transaction
 */
 ...
 */
 ...
 /**
 * Get vacant rooms with no active listing
 */
...
// ─── AI Rental Post Draft Interfaces ───────────────────────────────
